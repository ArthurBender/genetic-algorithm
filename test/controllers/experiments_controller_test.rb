...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { fitness: @experiment.fitness, generations: @experiment.generations, mutation: @experiment.mutation, population: @experiment.population, word: @experiment.word } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { fitness: @experiment.fitness, generations: @experiment.generations, mutation: @experiment.mutation, population: @experiment.population, word: @experiment.word } }
